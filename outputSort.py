...
parser.add_argument("directory", type = str, help = "Results folder input")
parser.add_argument("filename", type = str, help = "Name of results file")
...
filen = open(args.directory + "/" + args.filename, 'r')
line = filen.readline()
while(line):
...
fileObj = file(args.directory + '/sortedOutput.txt', 'w')
